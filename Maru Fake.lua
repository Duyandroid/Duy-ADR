-- Gravity Hub | Vision 1.3 - Preview (LocalScript)
...
-- tab system
local TabNames = {"Info","Main","Settings","Fish","Quests","SeaEvent","Mirage","Race","Drago","Prehistoric","Raids","Combat","Travel","Shop","Misc"}
local TabButtons = {}
local TabPages = {}
