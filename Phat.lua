...
do
    ...
    b.Draggable = true
    b.Image = "rbxassetid://122586116993940"
    c.Parent = b,
    local function d()
...
spawn(
    ...
    local EzAndepzai = Tabs.Item:AddSection("World Quest")
                   ...
                   game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") then
                    if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SweetChaliceNpc"), "Where") then
                        game.StarterGui:SetCore("SendNotification", {
                            Title = "Duy Android Notification",
                            Text = "Not Have Enough Material",
                            Icon = "http://www.roblox.com/asset/?id=122586116993940",
                            Duration = 2.5
                        })
                    else
                ...
                Fluent:Notify(
                    {
                        ...
                        Content = "Duy Android Hub Premium Notification",
                        Duration = 10
                    }
                )
                IslandFound = true
